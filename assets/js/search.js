const ASSETS = [
  ...
  },
  {
    ...
    link: "https://drive.google.com/file/d/1-20jb9ubog5Yr-FSkGGgwNRZZudky066O/view?usp=drive_link",
    linkText: "VIEW IMAGE",
...
document.getElementById('cat-count').textContent   = new Set(ASSETS.map(a => a.category)).size;
